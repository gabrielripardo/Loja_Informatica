...
<body>        
    <div class="container">
        <h1>Produtos</h1>                                
        <div class="row">
            <div class="col-4 align-self-center text-center border">
                <input type="text" placeholder="col-4 text-center border">
            </div>
            <div class="col-4 text-center border">
                <input type="text" placeholder="col-4 text-center border">
            </div>
            <div class="col-4 align-self-end text-center border">
                <input type="text" placeholder="col-4 text-right border">
                <input type="text" placeholder="col-4 text-right border">
                <input type="text" placeholder="col-4 text-right border">
            </div>
            <div class="col-4 align-self-center border">
                <input type="text" placeholder="col-4 text-center border">
            </div>
            <div class="col-4 align-self-center text-right border">
                <input type="text" placeholder="col-4 text-center border">
            </div>
            <div class="col-4 border">
                <input type="text" placeholder="col-4 border">
                <input type="text" placeholder="col-4 border">
                <input type="text" placeholder="col-4 border">
            </div>
        </div>
        <div class="row border">
            ...
            <div class="col-3 text-right border">
                <input type="text" placeholder="col-3 text-right border">                
            </div>
            <div class="col-3 align-self-end text-left border">
                <input type="text" placeholder="col-3 text-right border">                
            </div>
            <div class="col-3 align-self-end text-right border">
                <input type="text" placeholder="col-3 text-right border">                
            </div>
        </div>
